...
from min_energy_path.gaussian_mix import gaussian_field, gaussian_field_grad
...
mix_mean = gaussian_mix_params[:, 2:].T  # Use column vectors
...
# Work out z
z_flat = gaussian_field(coords, mix_mag, mix_sig, mix_mean)
...
grad = gaussian_field_grad(arrow_coords, mix_mag, mix_sig, mix_mean)
